...
Definition foo_bar_baz_mutIndMixin := [mutIndType for foo_bar_baz_rect].
Canonical foo_indType := IndType _ foo foo_bar_baz_mutIndMixin.
Canonical bar_indType := IndType _ bar foo_bar_baz_mutIndMixin.
Canonical baz_indType := IndType _ baz foo_bar_baz_mutIndMixin.
